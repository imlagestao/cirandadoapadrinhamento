...
// O polyfill do DOMMatrix (necessário em produção/serverless, onde o binário
// nativo que o pdfjs-dist tentaria usar não está disponível) é aplicado em
// src/instrumentation.ts, que roda garantidamente antes de qualquer coisa.
